...
const UserDashboard = ({ email, onLogout }) => {
  ...
  const shareStatsOnTwitter = () => {
    ...
    const referrals = dashboardData?.referrals?.completed || 0;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-gray-900/50 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm">
              ...
              <p className="text-3xl font-bold">{dashboardData?.referrals?.completed || 0}</p>
          ...
          <div className="bg-gray-900/30 backdrop-blur-sm rounded-3xl p-8 border border-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {['bronze', 'gold', 'platinum'].map((tier) => {
                ...
                const DropIcon = dropDisplay.icon;
                ...
                return (
                  ...
                  >
                    <div className={`${dropDisplay.bgColor} rounded-2xl p-6 border ${dropDisplay.border} backdrop-blur-sm overflow-hidden`}>
                      ...
                      {/* Content */}
                      <div className="relative z-10">
                        <div className={`w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br ${dropDisplay.gradient} flex items-center justify-center shadow-2xl ${dropDisplay.shadowColor} group-hover:scale-110 transition-transform duration-300`}>
                          <DropIcon className="w-10 h-10 text-white" />
                        </div>
                ...
                <div className="space-y-3 max-h-64 overflow-y-auto custom-scrollbar">
                  {dashboardData.drops.recent.slice(0, 5).map((drop, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${dropDisplay.gradient} flex items-center justify-center shadow-lg ${dropDisplay.shadowColor} group-hover:scale-110 transition-transform`}>
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-400">
                              From: {drop.earned_from_email?.split('@')[0]}***@{drop.earned_from_email?.split('@')[1]}
                            </p>
                          </div>
                        </div>
