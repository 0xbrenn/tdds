...
import { Check,Trophy, Twitter, MessageCircle, AlertCircle, Users, Link2, Mail, Loader2, ArrowRight, Copy, Download, Share2, ExternalLink, ArrowLeft, X, CheckCircle, Info, TrendingUp } from 'lucide-react';
...
const shareOnTwitter = () => {
  ...
  <button
    onClick={() => {
      setIsLoginFlow(true); // Set to login mode
      setCurrentStep('email');
    }}
